...
(function() {
    ...
    window.UEDITOR_HOME_URL = "/static/editor/ueditor1_2_6_0/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        UEDITOR_HOME_URL: URL
                ...
                //图片上传配置区
                , imageUrl: "/upload/uploadAttachedImage"             //图片上传提交地址
                , imagePath: "/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
                , imageFieldName: "picdata"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
                ...
                //附件上传配置区
                , fileUrl: URL + "/upload/uploadAttachedfile/"               //附件上传提交地址
...
//        }
                ...
                , initialStyle: 'body{font-size:14px}' //编辑器层级的基数,可以用来改变字体等

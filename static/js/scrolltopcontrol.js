var scrolltotop={
	...
	*/
	...
	setting: {startline:100, scrollto: 0, scrollduration:400, fadeduration:[400, 100]},
	controlHTML: '<a href="#top" title="返回顶部"><img src="/static/images/goTop.gif"></a>',
	controlattrs: {offsetx:5, offsety:55},
	anchorkeyword: '#top',
	...
	init:function(){
		jQuery(document).ready(function($){
			...
			mainobj.$control=$('<div id="topcontrol">'+mainobj.controlHTML+'</div>')
				...
				.css({position:mainobj.cssfixedsupport? 'fixed' : 'absolute', bottom:mainobj.controlattrs.offsety, left:$scrollToTopLeft, opacity:0, cursor:'pointer'})

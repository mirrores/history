...
return array(
    'rules' => array(
        ...
        'wedding' => array(
            'title' => array('not_empty' => null, 'min_length' => array(4), 'max_length' => array(80)),
            'start' => array('not_empty' => null),
            'finish' => array('not_empty' => null),
            'sign_start' => array('not_empty' => null),
            'sign_finish' => array('not_empty' => null),
            'address' => array('not_empty' => null),
            'year' => array('not_empty' => null),
            'content' => array('not_empty' => null),
        ),
        'weddingsign' => array(
            'bridegroom_name' => array('not_empty' => null,'chinese' => null),
            'bridegroom_company' => array('not_empty' => null),
            'bridegroom_email' => array('not_empty' => null,'email' => null),
            'bridegroom_address' => array('not_empty' => null),
            'bridegroom_mobile' => array('not_empty' => null,'numeric' => null),
            'bridegroom_qq' => array('not_empty' => null,'numeric' => null),
            'bridegroom_zipcode' => array('not_empty' => null,'numeric' => null),
            'bride_name' => array('not_empty' => null,'chinese' => null),
            'bride_company' => array('not_empty' => null),
            'bride_qq' => array('not_empty' => null,'numeric' => null),
            'bride_email' => array('not_empty' => null,'email' => null),
            'bride_address' => array('not_empty' => null),
            'bride_mobile' => array('not_empty' => null,'numeric' => null),
            'bride_zipcode' => array('not_empty' => null,'numeric' => null),
            'love_declaration' => array('not_empty' => null),
            'diploma_path' => array('not_empty' => null),
            'marriage_certificate_path' => array('not_empty' => null),
            'photo_path' => array('not_empty' => null),
        ),
        'history_info'=>array(
            'name'=>array('not_empty'=>null),
            'date'=>array('not_empty' => null),
            'content'=>array('not_empty'=>null),
            'grapheme'=>array('not_empty'=>null),
        ),
        'history_college'=>array(
            'name'=>array('not_empty'=>null),
            'depart_id'=>array('not_empty'=>null),
        ),
        'history_alumni'=>array(
        ),
        'history_professional'=>array(
            'name'=>array('not_empty'=>null),
            'depart_id'=>array('not_empty'=>null),
            'college_id'=>array('not_empty'=>null),
        ),
    ),
    'labels' => array(
        'abc' => '索引',
        ...
        'weddingsign' => array(
            ...
            'bridegroom_company' => '新郎单位名称',
            'bridegroom_email' => '新郎Email地址',
            'bridegroom_address' =>'新郎通讯地址',
            'bridegroom_mobile' => '新郎手机号码',
            'bridegroom_qq' =>'新郎QQ号码',
            'bridegroom_zipcode' => '新郎邮编',
            'bride_name' => '新娘姓名',
            'bride_company' => '新娘单位名称',
            'bride_qq' => '新娘QQ号码',
            'bride_email' => '新娘Email地址',
            'bride_address' =>'新娘通讯地址',
            'bride_mobile' => '新娘手机号码',
            'bride_zipcode' => '新娘邮编',
            'love_declaration' => '爱情宣言',
            'diploma_path' =>'毕业证书扫描文件',
            'marriage_certificate_path' => '结婚证扫描或照片',
            'photo_path' =>'婚纱照或生活照'
        ),
        'history_info'=>array(
            'name'=>'专业名称',

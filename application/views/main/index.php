...
<div class="row">
    ...
    <div id="alumni_event">
        ...
        <div style=" padding:5px 13px;min-height: 140px;">
            ...
            <div class="one_event<?= $key == 1 ? ' no_bg' : ''; ?>" style=" padding-bottom: 0">
                    <div class="left">
                        <?php if ($e['type']): ?>
        ...
        <div style=" padding:10px 13px;border-top:1px solid #BCDDEA">
            <div style=" text-align: center;float: left;color: #666" >
                <a href="http://e.weibo.com/zjuaa" target="_blank"><img src="/static/images/sina_weibo.jpg" width="75px" height="75px"/></a>
                    <div style=" margin-top: 5px">浙江大学校友总会<br>新浪微博</div>
            </div>
            <div style=" text-align: center;float: left;margin-left: 10px;color: #666" >
                <a href="http://zuaa.zju.edu.cn/news/view?id=4205"><img src="/static/images/weixinlogo.jpg" width="75px" height="75px"/></a>
                    <div style=" margin-top: 5px">浙江大学校友总会<br>官方微信</div>
            </div>
            <div class="clear"></div>
        </div>

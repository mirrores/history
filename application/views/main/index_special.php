...
<div class="row">
    ...
    <div id="alumni_event">
        ...
        <?php endif; ?>
        <div style=" padding:10px 13px;min-height: 255px">
    ...
    <?=
    View::factory('main/home_news_jitihunli', array(
        'top_news' => $top_news,
        'news_list' => $news_list,
        'weibolist' => $weibolist,
                        ...
                        <table cellspacing="0" cellpadding="0" width="322"  border="0">
                            <tr align="center">
                                <?php foreach ($old_pic as $p): ?>
                                    <td width="130" height="110"><p class="a_pic"><a href="<?= URL::site('album/picView?id=' . $p['id']) ?>" target="_blank"><img src="http://zuaa.zju.edu.cn<?= URL::base() . $p['img_path'] ?>" width="105" height="79" /></a></p></td>
                                <?php endforeach; ?>
                            </tr>
                        </table></td>

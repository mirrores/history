<div id="news" >
    ...
    <?php endif; ?>
    <div style="margin: 10px; text-align: right"><span class="middle"><img src="/static/ico/logo/t_sina.gif" /></span><a href="http://weibo.com/zjuaa" target="_blank">立即进入微博互动</a></div>
</div>
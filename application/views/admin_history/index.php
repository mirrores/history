<!-- admin_history/index:_body历史沿革模板 -->
<table class="admin_table" width="100%" border="0" cellpadding="0" cellspacing="1">
    <tr >
        <td height="29" class="td_title" >
            <a href="<?= URL::site('admin_history/export?q=' . $q) ?>" style="font-weight:normal">导出</a>
            <a  href="<?= URL::site('admin_history/form') ?>" style="font-weight:normal">添加专业</a>
    ...
    <?php else: ?>
        <?php foreach ($historys as $key => $h): ?>
            ...
            echo'even_tr';
                ...
                <td style="text-align:center"><a href="<?= URL::site('admin_history/list?id=' . $h['college_id']) ?>"  style=""><?= Text::limit_chars($h['college'], 10, '...') ?></a></td>

            ...
            <dl>
                ...
                <dd>
                    <ul>
                        ...
                        <li><div class="imgBox" style="width:250px;height: 185px;overflow: hidden; text-align: center"><img src="<?= $p['img_path'] ?>" height="185"  style="max-height: 185px; max-width: 250px" /></div><p><?= Text::limit_chars(trim($p['title']), 8) ?> — <?= $p['author']?></p><div class="div"></div></li>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </ul>
                </dd>

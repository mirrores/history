<form method="post" action="<?= URL::site('event/publish') ?>" id="event_form" >
    <div>
        ...
        <table cellpadding="0" align="left" border="0" cellspacing="0" id="eventTable">
            ...
            <tr>
                <td class="field" style="text-align: right">允许自建分组：</td>
                <td><span style="vertical-align: middle"><input type="checkbox" name="is_create_procession" id="is_create_procession" value="1"   <?=@$event['is_create_procession']?'checked':'';?>></span><label for="is_create_procession">是</label>&nbsp;&nbsp;<span style="color:#999">(是否允许校友自建队伍，设置为允许需要队长审核成员)，须填写“设置选择标签”</span></td>
            </tr>
            
        </table>
    </div>
</form>
<div id="event_formstatusTools" style="clear:both;margin:5px;padding:5px;"></div>

        ...
        <table cellpadding="0" align="left" border="0" cellspacing="0" id="eventTable">
            ...
            <?php if ($permission['is_control_permission']): ?>
                <tr>
                    ...
                    <td ><div id="uploading" style="display:none; color:#3993E0;width:600px; height:30px;"><img src="/static/images/loading4.gif"  hspace="4" align="absmiddle"  />正在上传中，请稍候...</div><input type="hidden" name="poster_path" id="filepath" value="<?= $event['poster_path'] ?>" /><iframe  id="upfileframe" name="upfileframe" scrolling="no" style="width:500px; height:30px; display:inline" frameborder="0" src="<?= URL::site('upload/frameimg?return_file_size=original&msg=图片大小640x340px') ?>"></iframe></td>
                </tr>
            <?php endif; ?>
            <tr>
            ...
            <tr>
                <td class="field" >暂停活动：</td>
                <td><span style="vertical-align: middle"><input type="checkbox" name="is_suspend" id="is_suspend" value="1"   <?=@$event['is_suspend']?'checked':'';?>></span>是&nbsp;&nbsp;<span style="color:#999">(将同时关闭报名、置顶、后续评分等功能)</span></td>
            </tr>
            <tr>
                <td class="field" >关闭报名：</td>
                <td><span style="vertical-align: middle"><input type="checkbox" name="is_stop_sign" id="is_stop_sign" value="1"   <?=@$event['is_stop_sign']?'checked':'';?>></span>是&nbsp;&nbsp;<span style="color:#999">(仅关闭报名，不影响已报名信息等其他功能)</span></td>
            </tr>
            
            <tr>
                <td class="field" >允许自建分组：</td>
                <td><span style="vertical-align: middle"><input type="checkbox" name="is_create_procession" id="is_create_procession" value="1"   <?=@$event['is_create_procession']?'checked':'';?>></span>是&nbsp;&nbsp;<span style="color:#999">(是否允许校友自建队伍，设置为允许需要队长审核成员)</span></td>
            </tr>

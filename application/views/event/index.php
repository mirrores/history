...
<div id="main_left">
    ...
    <?php endif; ?>
                ...
                <p class="p2">
                    ...
                    所属：<?php if ($e['aa_id'] == '-1'): ?><a href="<?= URL::site('aa') ?>"><?=$_CONFIG->base['orgname']?></a><?php else: ?><a href="<?= URL::site('aa_home?id=' . $e['aa_id']) ?>"><?= $e['Aa']['name'] ?></a> &raquo;<a href="<?= Db_Event::getLink($e['id'],$e['aa_id'],$e['club_id']) ?>"> <?= $e['Club']['name'] ? $e['Club']['name'] . '&raquo;' : '' ?></a><?php endif; ?><br />

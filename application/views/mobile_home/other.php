...
<div class="g  one-whole  desk-six-tenths" >
    <section class="posts" >
        <ul class="block-list">
            <li>
                <span class="post_time">2013年6月24日 星期六</span>
                <h4 class="post_title"><a href="/mobile_home/eview">春游之江大学•欧洲音乐欣赏</a></h4>
            </li>
            <li>
                <span class="post_time">06 February, 2013</span>
                <h4 class="post_title"><a href="d">隐居西湖黄严-打造隐居世界的梦想 </a></h4>
            </li>
            <li>
                <span class="post_time">29 January, 2013</span>
                <h4 class="post_title"><a href="">浙大网新考察交流（仅针对企业家校友） </a></h4>
            </li>

            <li>
                <span class="post_time">25 January, 2013</span>
                <h4 class="post_title"><a href="/2013">“双11” 191亿后的电子商务格局 </a></h4>
            </li>

            <li>
                <span class="post_time">23 January, 2013</span>
                <h4 class="post_title"><a href="/2">2013-3-16 爬山吃斋赏樱花活动 </a></h4>
            </li>
    ...
    <ul class="block-list">
        <li>
            <a href="http://inuitcss.com">
                <img src="/static/mobile/inuit.css-logo.png" alt="inuit.css" class="logo">
            </a>

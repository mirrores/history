...
<?= $main['intro'] ?></div>
	...
	<div style="width:200px;float:right;border:1px solid #E3EEF8;padding:10px;">
            <ul id="aa_info">
                <li><a href="<?= URL::site('aa') ?>" class="cur">浙江大学校友总会简介</a></li>
                <li ><a href="<?= URL::site('aa/constitution') ?>" <?php if($_C=='constitution'):?>class="cur"<?php endif;?>>浙江大学校友总会章程</a></li>
                <li><a href="<?=URL::site('aa/organization')?>" <?php if($_C=='organization'):?>class="cur"<?php endif;?>>浙江大学校友总会理事会</a></li>
    		          <li><a href="<?=URL::site('aa/memorabilia')?>" <?php if($_C=='memorabilia'):?>class="cur"<?php endif;?>>浙江大学校友总会大事记</a></li>

    ...
    <table class="admin_table" border="0" cellpadding="0" cellspacing="1" width="100%">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="checkbox" name="is_focus" value="1" style="vertical-align:middle;" id="is_focus"  <?= $news['is_focus'] ? 'checked' : '' ?>> <label for="is_focus">首页图片新闻</label>
        ...
        <tr>
            <td class="field">标题颜色：</td>

            <td>
                <select name="title_color" style="width:100px">
                    <option value='' <?= empty($news['title_color']) ? 'selected' : '' ?>>默认</option>
                    <option value="red"  <?= $news['title_color'] == 'red' ? 'selected' : '' ?> style="background-color:red;color: #fff">红色</option>
                     <option value="OrangeRed"  <?= $news['title_color'] == 'OrangeRed' ? 'selected' : '' ?> style="background-color:OrangeRed;color: #fff">橙红</option>
                    <option value="DarkRed"  <?= $news['title_color'] == 'DarkRed' ? 'selected' : '' ?> style="background-color:DarkRed;color: #fff">深红</option>
                    <option value="SaddleBrown"  <?= $news['title_color'] == 'SaddleBrown' ? 'selected' : '' ?> style="background-color:SaddleBrown;color: #fff">棕色</option>
                    <option value="Olive"  <?= $news['title_color'] == 'Olive' ? 'selected' : '' ?> style="background-color:Olive;color: #fff">橄榄</option>
                    <option value="Blue"  <?= $news['title_color'] == 'Blue' ? 'selected' : '' ?> style="background-color: Blue;color: #fff">纯蓝</option>
                    <option value="DarkGreen"  <?= $news['title_color'] == 'DarkGreen' ? 'selected' : '' ?> style="background-color: DarkGreen;color: #fff">深绿</option>
                    <option value="BlueViolet"  <?= $news['title_color'] == 'BlueViolet' ? 'selected' : '' ?> style="background-color: BlueViolet;color: #fff">深紫</option>
                    <option value="DarkCyan"  <?= $news['title_color'] == 'DarkCyan' ? 'selected' : '' ?> style="background-color: DarkCyan;color: #fff">深青色</option>
                    <option value="DimGray"  <?= $news['title_color'] == 'DimGray' ? 'selected' : '' ?> style="background-color: DimGray;color: #fff">深灰</option>
                    <option value="#333"  <?= $news['title_color'] == '#333' ? 'selected' : '' ?> style="background-color: #333;color: #fff">浅黑</option>
                    <option value="Black"  <?= $news['title_color'] == 'Black' ? 'selected' : '' ?> style="background-color: Black;color: #fff">纯黑</option>

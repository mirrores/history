...
class Db_Album {
    ...
    public static function getAlbums($condition) {
        ...
        //集体婚礼的
        if (isset($condition['wedding_id'])) {
            $album->addWhere('a.wedding_id = ' . $condition['wedding_id']);
        }
    ...
    public static function delete($condition) {
        ...
        if (isset($condition['id']) AND $condition['id']) {
            ...
            $query = $query->where('event_id', '=', $condition['event_id']);
        } elseif (isset($condition['wedding_id']) AND $condition['wedding_id']) {
            $query = $query->where('wedding_id', '=', $condition['wedding_id']);
        } else {
            return False;
        }

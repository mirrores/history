...
class Db_Comment {
    ...
    public static function get($condition) {
        ...
        elseif (isset($condition['video_id']) AND $condition['video_id']) {
            $all_comments = $all_comments->where('video_id', '=', $condition['video_id']);
            $comment = $comment->where('c.video_id', '=', $condition['video_id']);
        }

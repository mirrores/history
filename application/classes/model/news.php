...
class Model_News {
    ...
    public static function get($condition) {
        ...
        $is_show_branch = isset($condition['is_show_branch']) ? $condition['is_show_branch'] : null;
        ...
        //总会
        if ($aa_id == 'main') {
            $news->orderBy('is_fixed DESC, n.create_at DESC');
        ...
        //指定其他条件
        if ($is_show_branch) {
            $news->andWhere('n.is_show_branch = ?', $is_show_branch);
        }
        ...
        return $news->offset($pager->offset)->limit($limit)->fetchArray();
    }

...
class Kohana_Security {
    ...
    public static function xss_clean($str) {
        ...
        $str = str_replace("data:text/html;base64", '', $str);
        $str = str_replace("base64", '', $str);
        $str = str_replace("href=data:text/html", '', $str);
        ...
        do {
            ...
            $old = $str;
            $str = preg_replace('#</*(?:applet|b(?:ase|gsound|link)|frame(?:set)?|i(?:frame|layer)|l(?:ayer|ink)|meta|object|s(?:cript|tyle)|title|xml)[^>]*+>#i', '', $str);
        } while ($old !== $str);

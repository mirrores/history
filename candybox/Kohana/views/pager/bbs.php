...
?>
<div class="comment_pager" style="padding-left:0px; margin-left: 0px;*margin:0px 0px 0px 0px;*padding:0px" >
    <span class="total" >共&nbsp;<?=$total_items?>&nbsp;条话题&nbsp;</span>
	...
	<?php else: ?>
		<?php //echo __('Next') ?>
	<?php endif ?>
  <input type="hidden" value="<?=$page->url()?>" id="goto_url" >
  <span style="vertical-align:middle"><input type="text" class="input_text" id="<?=$goto_page_id?>" style="width:40px" >
  <input type="button" value="Go" class="button_gray" onclick="gotopage('<?=$goto_page_id?>')"></span>

...
<?php else: ?>
    <script type="text/javascript" src="/static/editor/ueditor1_2_6_0/ueditor.config.js"></script>
    <script type="text/javascript" src="/static/editor/ueditor1_2_6_0/ueditor.all.min.js"></script>
    <script type="text/javascript">
        readyScript.Ueditor = function() {
            ...
            window.ueditor = new baidu.editor.ui.Editor({
                ...
                iframeCssUrl: '/static/editor/ueditor1_2_6_0/<?= isset($attrs['iframeCssUrl']) ? $attrs['iframeCssUrl'] : 'themes/default/iframe.css'; ?>',

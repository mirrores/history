...
<?php else: ?>
    <link rel="stylesheet" href="/static/editor/ueditor1_2_5_1/themes/default/ueditor.css"/>
    <script type="text/javascript" src="/static/editor/ueditor1_2_5_1/editor_config.js"></script>
    <script type="text/javascript" src="/static/editor/ueditor1_2_5_1/editor_all_min.js"></script>
    <script type="text/javascript">
        readyScript.Ueditor = function() {
            ...
            window.ueditor = new baidu.editor.ui.Editor({
                ...
                iframeCssUrl: '/static/editor/ueditor1_2_5_1/<?= isset($attrs['iframeCssUrl']) ? $attrs['iframeCssUrl'] : 'themes/default/iframe.css?v=1.5'; ?>',

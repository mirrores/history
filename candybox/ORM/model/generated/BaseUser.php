 ...
 * @property Doctrine_Collection $EventSignCategorysss
 ...
 * @property Doctrine_Collection $Weddings
...
abstract class BaseUser extends Doctrine_Record
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('alumni_id', 'integer', 5, array(
             'type' => 'integer',
             'length' => '5',
             ));
        ...
        $this->hasColumn('file_no', 'integer', 20, array(
             'type' => 'integer',
             'length' => '20',
             ));
        ...
        $this->hasColumn('job', 'string', 50, array(
             'type' => 'string',
             'length' => '50',
             ));
    ...
    public function setUp()
    {
        ...
        $this->hasMany('EventSignCategorys as EventSignCategorysss', array(
             'local' => 'id',
             'foreign' => 'captain_id'));
        ...
        $this->hasMany('HistoryAlumni as User', array(
             'local' => 'id',
             'foreign' => 'user_id'));
        ...
        $this->hasMany('Wedding as Weddings', array(
             'local' => 'id',
             'foreign' => 'user_id'));
